...
//    private ImageView mBadgeFadeMask;
    ...
    public CommonCardView(Context context, AttributeSet attrs, int defStyle) {
...
//        inflater.inflate(com.orca.tvtutorial.R.layout.text_card, this);
        setCardType(BaseCardView.CARD_TYPE_INFO_UNDER);
        setInfoVisibility(BaseCardView.CARD_REGION_VISIBLE_ALWAYS);
        setFocusable(true);
        setFocusableInTouchMode(true);
//        View v = inflater.inflate(com.orca.tvtutorial.R.layout.common_card_view, this);
